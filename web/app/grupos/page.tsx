...
export const metadata: Metadata = {
  ...
  description:
    "Los grupos y sellos del mismo barro que Extremoduro y Robe: el rock estatal que compartió escenario, cartel y carretera con ellos.",
...
export default async function GruposPage() {
  ...
  try {
    items = await apiFetch<BandListItem[]>("/public/bands", {
      authenticated: false,
    });
  } catch {
    items = [];
      ...
      <main className="px-5 md:px-14 py-10 md:py-14 max-w-[1100px] mx-auto">
        ...
        <header className="mb-14">
          ...
          <p className="font-serif italic text-ink-dim text-lg mt-6 max-w-2xl leading-relaxed">
            ...
            Extremoduro y Robe. Las bandas y sellos del mismo barro.
          </p>
        </header>
