...
def _generate(
    ...
    *, material: str = "", corpus: str = "", content_type: str = "news",
    ...
    user = (
        ...
        "      · Los dos ejemplos de arriba enseñan la FORMA, no la frase: "
        "copiarlos cambiando el título es volver al molde por otro camino. "
        "Pregunta por lo que tenga ESTE post y no tengan los demás — el año, "
        "quién tocaba, el sitio, lo que se cuenta aquí y no se cuenta en otro "
        "sitio.\n"
