...
def pick_hero_image(
    db: Session, entities: list[dict] | None, *, used: set[str] | None = None
) -> dict[str, Any] | None:
    ...
    entre posts (regla dura: nunca dos posts con la misma foto). Si todas las
    imágenes de entidad ya están usadas, devuelve None → el caller cae al arte IA.
    """
    used = used or set()
